...
| Vehículo | `frmMantVehiculo` | `frmMantVehiculo` | `635,490` | `635,490` | `Registro de Tractores` | `Registro de Tractores` | Metadata/icon/control parity and behavior tests added; schema-backed configuration limit is 5; legacy preserved until the new implementation is 100% complete and confirmed |
