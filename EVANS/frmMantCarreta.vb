...
Public Class frmMantCarreta
    ...
    Private Sub lvListado_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles lvListado.DoubleClick
        ...
        Try
            ...
            objCarreta.Codigo = strCodigo
            If objCarreta.BuscarXCodigo() Then

                TabControl1.TabPages(1).Enabled = True
                TabControl1.TabPages(0).Enabled = False
                TabControl1.SelectTab(1)

                txtCodigo.Text = objCarreta.Codigo
                txtMarca.Text = objCarreta.Marca
                txtPlaca.Text = objCarreta.Placa
                txtCertificado.Text = objCarreta.CertificadoInscripcion
                cbEmpresa.Text = objCarreta.Empresa.Nombre
                cbEstado.Text = objCarreta.Estado.Descripcion
    ...
    Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        ...
        Try
            If txtMarca.Text = "" Or txtPlaca.Text = "" Or cbEmpresa.Text = "" Or cbEstado.Text = "" Then
                MessageBox.Show("Datos incompletos", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If

            objCarreta.Marca = txtMarca.Text
            objCarreta.Placa = txtPlaca.Text
            objCarreta.CertificadoInscripcion = txtCertificado.Text
            objCarreta.Empresa.Codigo = BuscarCodigo("empr_codigo", "empr_nombre", cbEmpresa.Text, "Empresa")
            objCarreta.Estado.Codigo = BuscarCodigo("esta_codigo", "esta_descripcion", cbEstado.Text, "Estado")

            If bolAccion = True Then
                If objCarreta.Grabar() = False Then
                    Return
                End If
            Else
                If objCarreta.Actualizar() = False Then
                    Return
                Else
                    bolAccion = True
                End If
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Try
            ...
            Else
                lvListado.Items.Clear()
                objCarreta.Placa = txtBuscar.Text

                Dim drLista As SqlDataReader

                drLista = objCarreta.BuscarXPlaca()
