...
Public Class frmMantEmpresa

    Dim objEmpresa As New clsEmpresa
    Dim bolAccion As Boolean = True

    Private Sub frmMantEmpresa_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmMantEmpresa_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub optTodos_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optTodos.CheckedChanged
        ...
        Try
            ...
            drLista = objEmpresa.Listar()

            While drLista.Read()
                Dim itemLista As ListViewItem
                itemLista = lvListado.Items.Add(NullToString(drLista("empr_codigo")))
                itemLista.SubItems.Add(NullToString(drLista("empr_nombre")))
                itemLista.SubItems.Add(NullToString(drLista("empr_ruc")))
                If NullToString(drLista("empr_propiedad")) = True Then
                    itemLista.SubItems.Add("SI")
                Else
                    itemLista.SubItems.Add("NO")
                End If
            End While
            drLista.Close()
            drLista.Dispose()
    ...
    Private Sub lvListado_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles lvListado.DoubleClick
        ...
        Try
            ...
            objEmpresa.Codigo = strCodigo
            If objEmpresa.BuscarXCodigo() Then

                TabControl1.TabPages(1).Enabled = True
                TabControl1.TabPages(0).Enabled = False
                TabControl1.SelectTab(1)

                txtCodigo.Text = objEmpresa.Codigo
                txtNombre.Text = objEmpresa.Nombre
                txtDireccion.Text = objEmpresa.Direccion
                txtTelefono.Text = objEmpresa.Telefono
                txtRUC.Text = objEmpresa.RUC
                If objEmpresa.Propiedad = True Then
                    cbPropiedad.Text = "SI"
                Else
                    cbPropiedad.Text = "NO"
                End If
                cbEstado.Text = objEmpresa.Estado.Descripcion
    ...
    Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        ...
        Try
            If txtNombre.Text = "" Or txtDireccion.Text = "" Or txtRUC.Text = "" Or cbPropiedad.Text = "" Or cbEstado.Text = "" Then
                MessageBox.Show("Datos incompletos", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Return
            End If

            objEmpresa.Nombre = UCase(txtNombre.Text)
            objEmpresa.Direccion = UCase(txtDireccion.Text)
            objEmpresa.Telefono = txtTelefono.Text
            objEmpresa.RUC = txtRUC.Text
            If LCase(cbPropiedad.Text) = "si" Then
                objEmpresa.Propiedad = True
            Else
                objEmpresa.Propiedad = False
            End If
            objEmpresa.Estado.Codigo = BuscarCodigo("esta_codigo", "esta_descripcion", cbEstado.Text, "Estado")


            If bolAccion = True Then
                If objEmpresa.Grabar() = False Then
                    Return
                End If
            Else
                If objEmpresa.Actualizar() = False Then
                    Return
                Else
                    bolAccion = True
                End If
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Try
            ...
            Else
                lvListado.Items.Clear()
                objEmpresa.Nombre = txtBuscar.Text

                Dim drLista As SqlDataReader

                drLista = objEmpresa.BuscarXNombre()
                ...
                While drLista.Read()
                    ...
                    itemLista.SubItems.Add(NullToString(drLista("empr_nombre")))
                    itemLista.SubItems.Add(NullToString(drLista("empr_ruc")))
                    itemLista.SubItems.Add(NullToString(drLista("empr_propiedad")))
                End While
                drLista.Close()
            End If
