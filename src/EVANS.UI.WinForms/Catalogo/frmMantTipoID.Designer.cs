...
partial class frmMantTipoID
{
    ...
    private Label lblCodigoRequired = null!;
    ...
    {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmMantTipoID));
        btnNuevo = new Button();
        ...
        lvListado.Columns.AddRange(new ColumnHeader[] { columnHeaderCodigo, columnHeaderDescripcion });
        ...
        columnHeaderCodigo.Width = 69;
        columnHeaderDescripcion.Text = "Descripción";
        columnHeaderDescripcion.Width = 409;
        ...
        tabPageDetalles.Controls.Add(lblCodigoRequired);
        ...
        lblRequired.Location = new Point(352, 87);
        ...
        lblCodigoRequired.BackColor = SystemColors.Control;
        lblCodigoRequired.Cursor = Cursors.Default;
        lblCodigoRequired.Font = new Font("Microsoft Sans Serif", 9.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
        lblCodigoRequired.ForeColor = SystemColors.ControlText;
        lblCodigoRequired.Location = new Point(352, 50);
        lblCodigoRequired.Name = "Label10";
        lblCodigoRequired.RightToLeft = RightToLeft.No;
        lblCodigoRequired.Size = new Size(9, 17);
        lblCodigoRequired.TabIndex = 54;
        lblCodigoRequired.Text = "*";
        ...
        Name = "frmMantTipoID";
        Text = "Registro de Tipos de Identificación";
